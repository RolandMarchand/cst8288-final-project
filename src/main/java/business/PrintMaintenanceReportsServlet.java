...
public class PrintMaintenanceReportsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PrintMaintenanceReportsServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PrintMaintenanceReportsServlet please implement business logic</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
